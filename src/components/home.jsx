...
const Home = () => {
  ...
  return (
    <div
      name="home"
      className="min-h-screen w-full bg-gradient-to-b from-black to bg-gray-800 via-black"
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row pt-20 md:pt-40">
        <div className="flex flex-col justify-center h-full md:w-3/5 w-full">
          ...
          <p className="text-gray-500 py-4 max-w-md">
            ...
            MERN stack, passionate about creating dynamic and user-friendly web
            applications. I've developed multiple projects, with experience in
